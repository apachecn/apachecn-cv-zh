...
当我们需要压缩或拉伸图像中一定范围的灰度时，对数变换非常有用；例如，为了显示傅里叶频谱（其中直流分量值远高于其他分量，因此如果没有对数变换，几乎总是看不到其他频率分量）。对数变换的点变换函数为一般形式![](Images/2ff32eb4-eb01-4fb3-9cb8-c54fe4bb7da6.png)，其中*c*为常数*。*
...
![](Images/e213bcbf-833f-4c0d-bcf2-03e191237e37.png)
...
![](Images/f4269fe0-46cf-4d64-9d45-bfa9a02dbf12.png)
...
![](Images/861ab0b9-f134-4750-8015-7e2091c28dcd.png)
...
![](Images/8fe7383d-489d-40a9-9b7a-32aa61524609.png)

# 阈值

这是一个点操作，通过将低于某个阈值的所有像素变为零，将高于该阈值的所有像素变为一，从灰度图像创建二值图像，如以下屏幕截图所示：

![](Images/afd8394c-007d-4451-a4d9-06d80fb79338.png)

如果*g（x，y）*是*f（x，y）*在某个全局阈值*T*下的阈值版本，则可以应用以下内容：

![](Images/62d2f5b3-9b92-4691-9ef9-ce25577d96bf.png)
...
![](Images/c01bd7d2-a638-4537-bd7b-7367e3ae9dc9.png)

此外，从下面可以看出，使用不同灰度阈值获得的二值图像未正确着色，导致被称为**假轮廓*的伪像：*

 *![](Images/4781e8bb-82b7-4eb8-9632-c85ba3274b0d.png)

![](Images/da9c8ee0-83c0-4b07-a1a1-73b684f116a8.png)
...
![](Images/afb98071-eab5-4456-b0ba-dfae1312b19b.png)
...
![](Images/2a8a3009-ec91-45eb-908e-c76b612adcd7.png)

下面的屏幕截图显示了使用前面伪代码的 Python 实现获得的输出二进制图像；与之前的半色调方法相比，它在获得的二值图像质量方面有了显著的改进：

![](Images/ad7a8b2d-cec3-4d07-bf0c-80f5118f4db1.png)
...
![](Images/e23fdde6-f8cf-4caa-b7b8-656259f61d34.png)
...
![](Images/5823816a-103e-4888-8c9d-19c0fcbcdf6c.png)

![](Images/fde43eab-0abd-42f1-8f19-b6696833dd18.png)

![](Images/ea138e57-e7c5-4c9e-8625-10d36c704fb2.png)

以下屏幕截图显示了局部（近似均匀）与自适应（拉伸和分段均匀）直方图均衡化的像素分布变化情况：

![](Images/1a503d13-07c3-454c-bba7-2ba6fb573d60.png)
...
![](Images/4ca63139-5afb-4caa-b19f-2595fa0a0ab9.png)

使用低对比度彩色 cheetah 输入图像，前面的代码生成以下输出：

![](Images/fc0ab8f3-06bf-4e46-880f-63a9328517e8.png)
...
![](Images/5346ef6d-e39e-44f6-8958-412699a64768.png)

**输出图像**

![](Images/e37ff7ce-e7b7-43e2-8cd2-c3fb6b52ab88.png)
...
![](Images/be9f755d-2379-4410-aad0-97b5d8e0f819.png)
...
![](Images/57e43eca-0ad3-4173-bd1c-6af8e612b4a7.png)
...
![](Images/b4b6a1b1-6811-4a90-8447-7822eeeae00e.png)
...
![](Images/85a61d22-b8ed-4abd-a245-321f0275c956.png)
...
![](Images/68ef0ac8-592a-4e1a-80f5-3658fa5fffd3.png)
...
![](Images/d30adda3-3c27-4108-bf8e-e342986c11de.png)
...
![](Images/4fd24fe2-9509-44c7-b26c-94799cb4897a.png)
