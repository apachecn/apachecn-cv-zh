...
![](Images/fd0ebf8c-2f06-475a-b6ef-daa014cd83ca.png)
...
![](Images/155b4477-5e1b-44b2-930e-3daa474b9d7d.png)
...
![](Images/8f5fbc5f-463e-4bd5-8be3-22d5e5a450c7.png)
 ...
 *![](Images/ca086560-bc06-490e-aa9f-73e717374685.png)

同样，让我们尝试使用以下照片作为输入：

![](Images/39a78848-1924-4201-9043-7a97c2f09937.png)

我们将检测以下对象（汽车、公共汽车、人、伞）：

![](Images/fa4d063f-6d25-4548-9627-3d0677382d95.png)
...
![](Images/1aa5b349-5a66-456a-8afa-080a7b07a525.png)
...
![](Images/d929fc98-db73-4c77-9d60-4b4582fa03e2.png)
...
![](Images/c5c28219-be6f-483c-8085-79940f9d3376.png)

# 基于 Keras 的迁移学习

对许多综合图像分类问题进行预训练模型的训练。卷积层充当特征提取器，**完全连接的***（***FC***层充当分类器*、*，如下图所示，在使用 conv 网络进行猫狗图像分类的情况下：*

 *![](Images/34041fa9-e175-44cf-b818-e5c96473bd39.png)
...
![](Images/2f698b69-5259-4f48-9266-aa3ad9cfb284.png)
...
![](Images/a8d7ca44-e30c-4b97-9d8d-408c90141777.png)

我们希望最小化图像 S 和 G 的 Gram 矩阵之间的距离。整体加权*样式损失*（我们希望最小化）表示为：

![](Images/1d757fd8-f7d7-40c2-9c6f-364d6f07aff7.png)
...
![](Images/74b2407d-2c6e-4b65-892f-75dacfc55ec5.png)
...
![](Images/327d9ad7-2745-4c0a-bee5-28acf98bb034.png)

以下是输入式图像，梵高的《星夜》：

![](Images/203ddd5b-1497-474b-9757-770a1c9931ed.png)

以下是由深度学习模型生成的输出图像，其中星夜图像的样式被传输到蒙娜丽莎的内容输入图像上：

![](Images/4eb02fb7-d9c9-451f-b840-e0c78e3eae0b.png)
