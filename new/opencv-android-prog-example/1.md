...
1.  Open the `layout` file and edit it to match the following code. We added the OpenCV namespace and defined a Java camera view layout:
    ...
    **下载示例代码**
    ...
    您可以从[这个页面](http://www.packtpub.com)下载从帐户购买的所有 Packt 书籍的示例代码文件。 如果您在其他地方购买了此书，则可以访问 [http://www.packtpub.com/support](http://www.packtpub.com/support) 并进行注册，以便将文件直接通过电子邮件发送给您。
