...
3.  选择“Makefile项目”，选择“其他工具链”，然后单击“完成”：
...
13.  生成项目。
14.  我们需要包括一些目录，以便我们可以编写C ++代码并使用**标准模板库**（**STL**）和OpenCV。 为此，请右键单击“项目名称 | 属性 | C/C++ 常规 | 路径和符号”。
    ### 注意
...
2.  选择“SDK位置”。 在“Android NDK位置”中，选择NDK所在的目录。 请注意，我们将使用实验性Gradle插件版本2.5来构建项目； 因此，我们需要NDK版本r10e：
