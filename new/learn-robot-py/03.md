...
访问以下下载页面以为您的 OS 平台安装 Blender： [http://www.blender.org/download/](http://www.blender.org/download/) 。您可以在此处找到 Blender 的最新版本。 另外，您可以在[这个页面](http://wiki.blender.org/)上找到有关 Blender 的最新文档。
