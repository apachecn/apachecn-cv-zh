...
在[这个页面](https://github.com/orbbec/ros_astra_camera)和 [http://wiki.ros.org/Sensors/OrbbecAstra 中提到了在 Ubuntu 中设置 Astra-ROS 驱动程序的完整说明。](http://wiki.ros.org/Sensors/OrbbecAstra) 。 安装驱动程序后，可以使用以下命令启动它：
