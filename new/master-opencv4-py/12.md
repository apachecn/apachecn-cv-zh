...
*   **ResNet-18，-34，-50，-101 和-152（2015）**：
    ...
    *   **参考文献**：`He, K., Zhang, X., Ren, S., and Sun, J. (2016). Deep residual learning for image recognition. In Proceedings of the IEEE conference on computer vision and pattern recognition (pp. 770-778).`
*   **Inception V3（2015）**：
...
*   **R-CNN（2014）**：
    ...
    *   **参考文献**：`Girshick, R., Donahue, J., Darrell, T., and Malik, J. (2014). Rich feature hierarchies for accurate object detection and semantic segmentation. In Proceedings of the IEEE conference on computer vision and pattern recognition (pp. 580-587).`
*   **快速 R-CNN（2015）**：
...
*   **YOLO（2016）**：
    ...
    *   **参考文献**：`Redmon, J., Divvala, S., Girshick, R., and Farhadi, A. (2016). You only look once: Unified, Real-Time Object Detection.`
*   **SSD（2016）**：
    *   **描述**：**单发多盒检测器**（**SSD**）是一个深层神经网络，旨在通过以下方法同时预测边界框和类概率 到端卷积神经网络架构的概念。
    *   **参考文献**：`Liu, W., Anguelov, D., Erhan, D., Szegedy, C., Reed, S., Fu, C. Y., and Berg, A. C. (2016, October). SSD: Single Shot Multibox Detector. In European conference on Computer Vision (pp. 21-37). Springer, Cham.`
*   **YOLO V2（2016）**：
