...
有关如何安装这些要求的更多详细信息，请参见第 1 章，“设置 OpenCV”。 *使用 Python* 掌握 OpenCV 4 的 GitHub 存储库，其中包含所有支持的项目文件，这是从第一章到最后一章学习本书所必需的，[可以在下一个 URL 中访问](https://github.com/PacktPublishing/Mastering-OpenCV-4-with-Python/)。
