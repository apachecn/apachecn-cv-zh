...
[Dlib](http://dlib.net/python/index.html) 是一个 C++ 软件库，包含计算机视觉，机器学习和深度学习算法。 Dlib 也可以在您的 Python 应用中使用。 [为了使用 Python 界面](https://pypi.org/project/dlib/)安装`dlib`，请使用以下命令：
