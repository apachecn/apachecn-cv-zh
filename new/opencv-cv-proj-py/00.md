...
wxPython 2.8 或更高版本：此 GUI 编程工具包可从 [http://www.wxpython.org/download.php](http://www.wxpython.org/download.php) 获得。 在[这个页面](http://wxpython.org/builddoc.php)上提供了其安装说明。
