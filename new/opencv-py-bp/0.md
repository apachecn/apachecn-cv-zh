...
*   **Python** 2.7 或更高版本： [https://www.python.org/downloads](https://www.python.org/downloads) 上提供了最新的 32 位和 64 位安装程序。 可以在[这个页面](https://wiki.python.org/moin/BeginnersGuide/Download)上找到安装说明。
