...
您可以通过 [https://diffractionlimited.com/help/maximdl/High-Pass_Filtering.htm](https://diffractionlimited.com/help/maximdl/High-Pass_Filtering.htm) 了解更多有关高通滤波器的信息。 信号滤波器的另一种类型是带通滤波器，它可以使一个频率范围（或频带）内的信号通过。 这些滤镜使我们可以突出显示图像的边缘并通过同时使用模糊来减少噪点。 您可以在[这个页面](https://homepages.inf.ed.ac.uk/rbf/HIPR2/freqfilt.htm)上阅读有关它们的更多信息。
