...
可以在 GitHub 上的 [https://github.com/PacktPublishing/raspberry-pi-computer-vision-programming/tree/master/Chapter12/programs](https://github.com/PacktPublishing/raspberry-pi-computer-vision-programming/tree/master/Chapter12/programs) 上找到本章的代码文件。

观看以下视频，以查看 [https://bit.ly/3fWRYDB](https://bit.ly/3fWRYDB) 上的“正在执行的代码”。
...
您可以通过参考 [https://mahotas.readthedocs.io/en/latest/](https://mahotas.readthedocs.io/en/latest/) 了解有关 Mahotas 的更多信息。
...
**mahotas.otsu（）**函数接受灰度图像作为参数，并返回阈值。 **照片> T_otsu** 代码返回阈值图像。 以下是输出：
...
*   **SimplelTK** （ [http://www.simpleitk.org/](http://www.simpleitk.org/) ）
*   **scipy.ndimage** （ [https://docs.scipy.org/doc/scipy/reference/ndimage.html](https://docs.scipy.org/doc/scipy/reference/ndimage.html) ）
...
这将启动 Jupyter Notebook 服务器进程并打开具有 Jupyter Notebook 界面的 Web 浏览器窗口，如下所示：
