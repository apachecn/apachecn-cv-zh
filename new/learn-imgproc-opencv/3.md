...
**翻译**示例向您展示如何使用`warpAffine`功能翻译图像。 示例代码为：
...
有关 OpenCV 中使用的修复算法的更多详细信息，请参见 [http://www.ifp.illinois.edu/~yuhuang/inpainting.html](http://www.ifp.illinois.edu/~yuhuang/inpainting.html)
...
有关非局部均值和 TVL1 去噪算法的更多信息，请访问 [http://www.ipol.im/pub/art/2011/bcm_nlm](http://www.ipol.im/pub/art/2011/bcm_nlm) 和 [http：// znah .net / rof-and-tv-l1-denoising-with-primal-dual-algorithm.html](http://znah.net/rof-and-tv-l1-denoising-with-primal-dual-algorithm.html) 。
