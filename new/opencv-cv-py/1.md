...
要查看与 OpenCV 相关的 CMake 配置标志，我们需要查看其源代码。 从[这个页面](http://sourceforge.net/projects/opencvlibrary/files/opencv-unix/2.4.3/OpenCV-2.4.3.tar.bz2/download)下载源代码存档，将其解压缩到任何 位置，然后阅读`<unzip_destination>/OpenCV-2.4.3/CMakeLists.txt`。
