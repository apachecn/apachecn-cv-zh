...
*   **教程**： [http://docs.opencv.org/opencv_tutorials](http://docs.opencv.org/opencv_tutorials) （这些教程使用 C ++代码。有关教程代码的 Python 端口，参见 Abid RahmanK。 的资料库位于[这个页面](http://goo.gl/EPsD1)。）
