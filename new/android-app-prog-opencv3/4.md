...
这些图像是 19 世纪荷兰画家[文森特·梵高](http://en.wikipedia.org/wiki/Vincent_van_Gogh)和 16 世纪印度画家 [Basawan](http://en.wikipedia.org/wiki/Basawan)。 我们的跟踪器可以很好地处理这些图像，因为它们包含许多高对比度的细节，而无需重复很多图案。 因此，是，可以在每个图像的大多数部分中进行跟踪。 例如，这是巴沙旺（Basawan）的一幅画作*阿克巴猎豹猎豹*：
