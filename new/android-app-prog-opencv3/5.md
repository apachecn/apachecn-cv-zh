...
OpenCV 3.x 的版本位于 [http://nummist.com/opencv/4598_05.zip](http://nummist.com/opencv/4598_05.zip) 。

位于 [http://nummist.com/opencv/5206_05.zip](http://nummist.com/opencv/5206_05.zip) 的 OpenCV 2.x 版本。
...
在具有变焦镜头的设备上，水平和垂直视场可能基于镜头的最宽（1x）变焦设置。 有关基于当前缩放设置查找视野的建议，请参见 StackOverflow 帖子，网址为 [http://stackoverflow.com/a/12118760](http://stackoverflow.com/a/12118760) 。

在某些设备上，视野报告为 360 度或其他不正确的值。 例如，Sony Xperia Arc 可能报告 360 度的视野。

作为依赖`Camera.Parameters`的替代方法，我们可以要求用户在运行时校准摄像机。 OpenCV 提供了校准功能，要求用户拍摄棋盘的一系列照片。 我们不会在本书中介绍这些功能，但您可以在[的官方文档中了解它们，网址为 http://docs.opencv.org/doc/tutorials/calib3d/camera_calibration/camera_calibration.html](http://docs.opencv.org/doc/tutorials/calib3d/camera_calibration/camera_calibration.html) 或 其他 OpenCV 书籍，例如 RobertLaganière 的 *OpenCV 2 计算机视觉应用程序编程手册*（Packt Publishing）。
